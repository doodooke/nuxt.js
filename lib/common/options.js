...
import { defaults, defaultsDeep, isString, pick } from 'lodash-es'
import consola from 'consola'
import { guardDir, isPureObject, isUrl } from '../common/utils'
...
Options.from = function (_options) {
  ...
  // Apply defaults
  defaultsDeep(options, defaultConfig)
  ...
  if (options.dev && isUrl(options.build.publicPath)) {
    options.build.publicPath = defaultConfig.build.publicPath
  }
  ...
  if (csp) {
    options.render.csp = defaults(isPureObject(csp) ? csp : {}, cspDefaults)
  }
